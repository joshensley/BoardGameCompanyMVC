...
namespace BoardGameCompanyMVC.Data.Migrations
{
    ...
    [Migration("20210210204803_AddUserOrderToDb")]
    partial class AddUserOrderToDb
    {
            ...
            modelBuilder.Entity("BoardGameCompanyMVC.Models.UserOrder", b =>
                {
                    ...
                    b.Property<decimal>("OrderPricePerUnit")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("Quantity")
                        .HasColumnType("int");

                    b.Property<string>("UserCheckOutInputID")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("UserCheckOutInputID1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserCheckOutInputID1");
            ...
            modelBuilder.Entity("BoardGameCompanyMVC.Models.UserOrder", b =>
                {
                    ...
                    b.HasOne("BoardGameCompanyMVC.Models.UserCheckOutInput", "UserCheckOutInput")
                        .WithMany()
                        .HasForeignKey("UserCheckOutInputID1");

                    b.Navigation("ApplicationUser");

                    b.Navigation("BoardGame");

                    b.Navigation("UserCheckOutInput");
                });
